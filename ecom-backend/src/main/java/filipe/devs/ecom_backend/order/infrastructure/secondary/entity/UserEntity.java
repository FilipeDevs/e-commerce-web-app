package filipe.devs.ecom_backend.order.infrastructure.secondary.entity;


import filipe.devs.ecom_backend.order.domain.user.aggregate.User;
import filipe.devs.ecom_backend.order.domain.user.aggregate.UserBuilder;
import filipe.devs.ecom_backend.order.domain.user.vo.*;
import filipe.devs.ecom_backend.shared.jpa.AbstractAuditingEntity;
